...
for l in "$FASTQ_PATH"/*_L001_R1_001.fastq;
   ...
   echo -e "\n#### Sort reads"
   # (troubleshooting - GATK was complaining about incompatible contigs between bam and reference)
   java -Xmx10g -Xms10g -jar /home/magda/picard.jar ReorderSam \
   I="$RESULTS_PATH$SAMPLE_NAME".bam \
   O="$RESULTS_PATH$SAMPLE_NAME"_reordered.bam \
   ...
   -T DepthOfCoverage \
   -R /mnt/chr11/Data/magda/Powroty/panel/ref/hg38.fa \
   -I "$RESULTS_PATH$SAMPLE_NAME"_reordered.bam \
